...
Scenario: Begin Game
	...
	When I enter my name Kody
	Then the computer welcomes me to the game with "Welcome Kody"
...
Scenario: My Turn
	Given I have a started Tic-Tac-Toe game
		And it is my turn
		And the computer knows my name is Kody
	Then the computer prints "Kody's Move:"
